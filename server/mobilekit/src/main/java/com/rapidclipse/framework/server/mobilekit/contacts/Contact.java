...
public class Contact
{
	...
	public Contact(
		...
		final Collection<ContactField> phoneNumbers,
		final Collection<ContactField> emails,
		final Collection<ContactAddress> addresses,
		final Collection<ContactField> ims,
		final Collection<ContactOrganization> organizations,
		final String birthday,
		final String note,
		final Collection<ContactField> photos,
		final Collection<ContactField> categories,
		final Collection<ContactField> urls)
	{
		this.id            = id;
