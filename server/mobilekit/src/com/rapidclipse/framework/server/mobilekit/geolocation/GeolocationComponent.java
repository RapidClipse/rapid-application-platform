...
public class GeolocationComponent extends MobileComponent implements GeolocationService
{
	...
	@Override
	public void getCurrentPosition(final GeolocationOptions options,
	...
	@Override
	public void watchPosition(final GeolocationOptions options,
	...
	private static class CoordinatesImpl implements Coordinates
	{
		...
		CoordinatesImpl(final double latitude, final double longitude, final double altitude,
