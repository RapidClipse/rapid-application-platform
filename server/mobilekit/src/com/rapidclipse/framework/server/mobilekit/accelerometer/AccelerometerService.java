...
public interface AccelerometerService extends MobileService
{
	 ...
	 */
	default public void getCurrentAcceleration(final AccelerometerOptions options,
	 ...
	 *            acceleration data.
	 */
	public void getCurrentAcceleration(AccelerometerOptions options,
			Consumer<Acceleration> successCallback, Consumer<MobileServiceError> errorCallback);
