...
public class AccelerometerComponent extends MobileComponent implements AccelerometerService
{
	...
	@Override
	public void getCurrentAcceleration(final AccelerometerOptions options,
	...
	@Override
	public void watchAcceleration(final AccelerometerOptions options,
	...
	@ClientCallable
	void watchAcceleration_success(final String id, final JsonObject positionObj,
	...
	private class AccelerationWatchImpl implements AccelerationWatch
	{
		...
		AccelerationWatchImpl(final Acceleration Acceleration, final String id,
				final String watchId)
		{
			super();
