...
public interface MobileServiceConfiguration
{
	...
	public static MobileServiceConfiguration New(final Class<? extends MobileService> serviceClass,
	...
	public static class Implementation implements MobileServiceConfiguration
	{
		...
		public Implementation(final Class<? extends MobileService> serviceClass,
				final Map<String, String> params)
		{
			super();
