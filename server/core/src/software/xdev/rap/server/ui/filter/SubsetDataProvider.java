...
{
	public void configure(ComboBox<T> comboBox, final FilterContext context,
	...
	public static <T> SubsetDataProvider<T> New(final FetchItemsCallback<T> fetchItems,
	...
	public static <T> SubsetDataProvider<T> New(final ItemFilter<T> itemFilter,
	...
	public static <T> SubsetDataProvider<T> New(final ItemFilter<T> itemFilter,
			final Collection<T> items, final ItemLabelGenerator<T> itemLabelGenerator)
	{
		return (comboBox, context, property) -> {
			comboBox.setItemLabelGenerator(itemLabelGenerator);
	...
	public static <T, C> SubsetDataProvider<T> New(final DataProvider<T, C> dataProvider,
