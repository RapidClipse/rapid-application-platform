...
public interface Exporter
{
	...
	public StreamResource exportToResource(final InputStream jrxml, final JRDataSource dataSource,
	...
	public static Exporter New(final Format format, final DynamicExporter dynamicExporter,
	...
	public static class Implementation implements Exporter
	{
		...
		public Implementation(final Format format, final DynamicExporter dynamicExporter,
				final PlainExporter plainExporter)
		{
			super();
		...
		@Override
		public StreamResource exportToResource(final InputStream jrxml,
				final JRDataSource dataSource, final Map<String, Object> parameters)
		{
