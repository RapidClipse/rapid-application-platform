...
public final class Jpa
{
	...
	public static AttributeChain resolveAttributeChain(final Class<?> entityClass,
			final String propertyPath)
	{
		...
		return new AttributeChain(attributes);
	}
	...
	public static <E, F> Path<F> resolvePath(final Root<E> root,
	...
	{
		return StreamSupport.stream(attributeChain.spliterator(),false).map(Attribute::getName)
				.collect(Collectors.joining(PROPERTY_SEPARATOR));
	}
	...
	public static <T> T resolveValue(final Object entity, final AttributeChain attributeChain)
	{
		return resolveValue(entity,attributeChain.attributes());
	}
