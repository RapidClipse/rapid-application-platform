		...
		public static class Default implements Builder
		{
			...
			public Axis build()
			{
				return new Axis.Default(this.baseline, this.baselineColor, this.direction, this.format, this.gridlines,
					this.logScale, this.minorGridlines,
					this.scaleType, this.textPosition, this.textStyle, this.ticks, this.title, this.titleTextStyle,
					this.allowContainerBoundaryTextCufoff,
					this.slantedText, this.maxAlternation, this.maxTextLines, this.minTextSpacing, this.showTextEvery,
					this.maxValue, this.minValue,
					this.viewWindowMode, this.viewWindowMax, this.viewWindowMin);
			}
		}
