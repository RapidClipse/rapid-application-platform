...
public class XdevCalendarChart extends Composite<Div> implements HasSize
{
	private final String            id;
	private XdevCalendarChartConfig config;
	private DataTable               dataTable;
	
	public XdevCalendarChart()
	{
		super();
		this.id = IdGenerator.generateId();
		
		this.config = new XdevCalendarChartConfig();
	}
	 ...
	 * @param config
	 */
	public void setConfig(final XdevCalendarChartConfig config)
	{
		this.config = config;
	}
	...
	public void buildChart()
	{
		final ChartJsBuilder js   = new ChartJsBuilder(this.dataTable,
			this.config.getOptions(), this.id, "Calendar");
