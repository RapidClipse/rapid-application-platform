...
public class CalendarChart extends Composite<Div> implements HasSize
{
	private final String            id;
	private CalendarChartConfig config;
	 ...
	 * @param config
	 */
	public void setConfig(final CalendarChartConfig config)
	{
		this.config = config;
	}
