...
public interface SubjectRegistry
{
	...
	{
		return New(
			Default.buildRegistry(requireNonNull(subjects)),
			requireNonNull(registryLock));
	}
	 ...
	 * @author XDEV Software (TM)
	 */
	public final class Default implements SubjectRegistry
	{
		///////////////////////////////////////////////////////////////////////////
		// static methods //
		///////////////////
		 ...
		 *            the locking instance to be used to synchronize on for accessing the registry.
		 */
		protected Default(final Map<String, Subject> registry, final Object registryLock)
		{
			super();
