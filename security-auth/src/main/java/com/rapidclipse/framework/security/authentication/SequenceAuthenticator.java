...
public final class SequenceAuthenticator<C, R> implements Authenticator<C, R>
{
	 ...
	 *            the authenticators to be evaluated in order.
	 ...
	 *
	 * @param credentials
	 *            the credentials to be evaluated for the authentication.
	 * @return the first return value not deemed to indicate a failure or whatever the last authenticator returns.
	 * @throws AuthenticationFailedException
	 *             if the last authenticator throws an {@link AuthenticationFailedException}.
	 */
	@Override
