...
public interface RoleBuilder
{
	 ...
	 *
	 * @param roleManager
	 *            the {@link RoleManager} for which this builder shall build {@link Role} instances.
	 ...
	 *            the {@link RoleManager} for which this builder shall build {@link Role} instances.
	 * @param roleCreator
	 *            the {@link Role.Creator} instance to be used for creating new {@link Role} instances.
	 * @return a new {@link RoleBuilder} instance
	 */
