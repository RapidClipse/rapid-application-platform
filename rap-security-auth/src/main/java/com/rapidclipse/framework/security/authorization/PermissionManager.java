...
/**
 * Manager type that extends {@link PermissionRegistry} with functionality for mutating (managing) the registered
 * entries.
...
public interface PermissionManager extends PermissionRegistry, PermissionProvider
{
	 ...
	 *            the {@link PermissionProvider} instance to be used to provide {@link Permission}
	 *            instances.
	 * @return a new {@link PermissionManager} instance.
	 ...
	 *
	 * @param registryLock
	 *            the synchronization lock instance to be used for concurrency handling.
	 * @param permissionProvider
	 *            permissionProvider the {@link PermissionProvider} instance to be used to provide
	 *            {@link Permission} instances.
	 * @param table
	 *            the table to be used as the internal datastructure.
	 * @return a new {@link PermissionManager} instance.
	 * @see PermissionManager#New()
	 * @see PermissionManager#New(PermissionProvider)
	 */
