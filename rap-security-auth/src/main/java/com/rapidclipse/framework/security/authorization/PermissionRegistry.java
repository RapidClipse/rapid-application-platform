...
public interface PermissionRegistry
{
	 ...
	 *
	 * @param resource
	 *            the {@link Resource} instance for which the associated {@link Permission} instance shall be
	 *            returned.
	 * @param factor
	 *            the factor value of the {@link Resource} instance for which the associated {@link Permission}
	 ...
	 *
	 * @param permissions
	 *            the {@link Permission} instances to derive the internal datastructure from.
	 * @param registryLock
	 *            the locking instance to be used to synchronize on for accessing the registry.
	 * @return a new {@link PermissionRegistry} instance using the passed instances.
	 */
